...
<form onsubmit="return Validate();" action = "cargoInvoiceInitial" method="POST">
<div class="row">
  <div class="col-75">
    <div class="container">      
        <div class="row">
	  ...
	  <input type="hidden" id="passengerId" name="passengerId" value="${passengerId}" >
	 	...
	 	<input type="hidden" id="totalamount" name="totalamount" value="${50 + extraPrice}" >
		<input type="hidden" id="receiveremail" name="receiveremail" value="${receiveremail}" >
		<input type="hidden" id="loadingDate" name="loadingDate" value="${loadingDate}" >
		<input type="hidden" id="destaddress" name="destaddress" value="${destaddress}" >		
        </div>
        <label>
  ...
  <div class="col-25">
    <div class="container">
      ...
      <p><a href="#">Shipping Price</a> <span class="price">$50</span></p>
      <p><a href="#">Extra weight Price</a> <span class="price">$${extraPrice}</span></p>
      <p>Total <span class="price" style="color:black"><b>$${50 + extraPrice}</b></span></p>
    </div>
  </div>
</div>
</form>
