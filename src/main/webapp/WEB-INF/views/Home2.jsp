...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<li> <a href="/searchFlightsInitial">Book Flight</a><li>
			<li> <a href="/viewScheduleInitial">View Schedule</a><li>		
			<li> <a href="#">Current Status</a><li>			
			<li> <a href="/freightInfoInitial?fullname=${fullname}&userid=${userid}&email=${email}">Transport Cargo</a><li>
			</ul>
			<ul class = "nav navbar-nav navbar-right">
			<li><a href="#"><span class="glyphicon glyphicon-earphone"></span> Contact Us</a></li>
			<li><a href="register"> Sign Up</a></li>
			<li><a href="Loogin"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
			<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">${fullname}<span class="glyphicon glyphicon-user"></span>
			<span class="caret"></span></a>
			<input type="hidden" id="fullname" name="fullname" value="${fullname}" >
			<ul class="dropdown-menu">
				<li><a href="#">View My Bookings</a></li>
				<li><a href="/cancelTicketsInitial?fullname=${fullname}&userid=${userid}&email=${email}">Cancel Ticket</a></li>
				<li><a href="#">Edit ticket details</a></li>
				<li><a href="#">Update Contact Details</a></li>
				<li><a href="#">Edit Shipment details</a></li>
				<li><a href="/logoutt">LogOut Step 1</a></li>
			</ul>
			</ul>
